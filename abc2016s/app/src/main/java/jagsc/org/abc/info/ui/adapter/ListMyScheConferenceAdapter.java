 ...
 */
public class ListMyScheConferenceAdapter extends RecyclerView.Adapter<Const.MyScheConferenceViewHolder> {
    ...
    public ListMyScheConferenceAdapter(Context context, List<Conference> data) {
        mContext = context;
        mData = data;
    }
    ...
    public Const.MyScheConferenceViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(mContext)
                .inflate(R.layout.list_my_sche_conference_item, parent, false);
