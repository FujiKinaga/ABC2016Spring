...
public class FavoriteAction {
    ...
    //conferenceはidだとダメなのでtitleで判別する
    public static void favoriteConference(Context context, String title) {
    ...
    public static void unFavoriteConference(Context context, String title) {
        SharedPreferences pref = context.getSharedPreferences(PREFERENCE_CONFERENCE, Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = pref.edit();
    ...
    public static boolean isFavoriteConference(Context context, String title) {
        SharedPreferences pref = context.getSharedPreferences(PREFERENCE_CONFERENCE, Context.MODE_PRIVATE);
